...
# CFLAGS="-DDLONG -DCOPYAMATRIX -DLAPACK_LIB_FOUND -CTRLC=1 -DBLAS64 -DBLASSUFFIX=_64_" LDFLAGS="-L$HOME/julia/usr/bin -lopenblas" make CC=x86_64-w64-mingw32-gcc out/libscsdir.dll
# mv out bin64
# make clean
# CFLAGS="-DDLONG -DCOPYAMATRIX -DLAPACK_LIB_FOUND -CTRLC=1" LDFLAGS="-L$HOME/julia32/usr/bin -lopenblas" make CC=i686-w64-mingw32-gcc out/libscsdir.dll
# mv out bin32
...
cflags = "-DCOPYAMATRIX -DDLONG -DLAPACK_LIB_FOUND -CTRLC=1"
