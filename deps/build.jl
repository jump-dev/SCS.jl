...
bin_prefix = "https://github.com/juan-pablo-vielma/SCSBuilder/releases/download/v2.0.2-beta2"

# Listing of files generated by BinaryBuilder:
download_info = Dict(
    Linux(:aarch64, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.aarch64-linux-gnu.tar.gz", "f070f4992bb81ac916d0ae0dfdb0cb350932ab8cba615f10e1fab7c5e6d307c6"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf) => ("$bin_prefix/SCSBuilder.v2.0.2.arm-linux-gnueabihf.tar.gz", "c8478e74806ac0830f3c69cd277a14b80cc3b235913112e03d75dcd971501c2a"),
    Linux(:i686, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.i686-linux-gnu.tar.gz", "b6ea54e5eacbc857880d02eb47617a501aa084be22d3b58ee6d3d5392b8965d5"),
    ...
    Linux(:powerpc64le, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.powerpc64le-linux-gnu.tar.gz", "2ed0bf7ebbfd06d0bec2aae30971888127bb7dc3b036d5fbefc8a062d8199333"),
    ...
    Linux(:x86_64, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.x86_64-linux-gnu.tar.gz", "d4e9447d73fa493315d680819396786930fcaa0cb6aeade2310b086d982d39e3"),
