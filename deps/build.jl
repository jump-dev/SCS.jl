...
download_info = Dict(
    Linux(:aarch64, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.aarch64-linux-gnu.tar.gz", "11ca632545b5676f12ddbb17560e34600886291e8a2ae4b5ddbb91f536769823"),
    Linux(:armv7l, libc=:glibc, call_abi=:eabihf) => ("$bin_prefix/SCSBuilder.v2.0.2.arm-linux-gnueabihf.tar.gz", "fbea426d8e8450941e165a492187e0d45954c659a0dd698ce3daa160c8d006da"),
    Linux(:i686, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.i686-linux-gnu.tar.gz", "10a2971fe442bb3145cc494d476e69e77503831607ca841c078806185c477dcb"),
    ...
    Linux(:powerpc64le, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.powerpc64le-linux-gnu.tar.gz", "5d896de597eff706806c84a9f557adf108461ce781ec27f51eb6b94e6a1f4cf3"),
    ...
    Linux(:x86_64, libc=:glibc) => ("$bin_prefix/SCSBuilder.v2.0.2.x86_64-linux-gnu.tar.gz", "837ce623d34851b4055b0eaba8348b9833f06a287a05f7a3b8c5fcfa648b956f"),
